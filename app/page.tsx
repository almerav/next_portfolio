  ...
  return (
    <>
      ...
      <section
        ...
        style={{
          background:
            'radial-gradient(circle, rgba(255, 255, 255, 1) 0%, rgba(141, 135, 135, 1) 34%, rgba(12, 10, 10, 1) 68%)',
        }}
      >
        {/* Shooting Stars */}  
        <Fireflies/>
          ...
          <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-10 w-full text-white">
            {/* Left Side: Text */}
            <Animation>
            <div className="md:flex-1 text-center md:text-left font-intel">
              ...
              <p className="text-lg leading-relaxed max-w-md mx-auto md:mx-0">
                ...
                This site is your one-stop scroll to learn more about what I do, what I&apos;ve built,
                and the things that keep me awake at 2 AM{' '}
                <span className="text-white font-bold">(ง ͠ಥ_ಥ)ง</span>
              </p>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <Animation>
          <div className="font-intel flex flex-col md:flex-row justify-between items-center mb-14 gap-6 text-center md:text-left">
            <div>
              <h1>SOME OF MY</h1>
        ...
        >
          ...
          <div className="max-w-4xl w-full bg-gray-50 drop-shadow-lg p-10 rounded-xl shadow-lg relative z-10">
            <h2 className="font-intel text-4xl font-bold text-center mb-8 text-gray-800">Let&apos;s Connect</h2>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {/* Contact Info */}
              <div>
                <p className="font-intel text-lg mb-4 text-gray-700">
                  Got a question, opportunity, or just wanna say hi? Feel free to reach out!
                </p>
                <ul className="space-y-2 text-gray-600">
                  <li>
                    <strong className="font-intel">Email:</strong>{' '}
                    <a
                  ...
                  <li>
                    <strong className="font-intel">LinkedIn:</strong>{' '}
                    <a
                  ...
                  <li>
                    <strong className="font-intel">GitHub:</strong>{' '}
                    <a
              ...
              >
                <div>
                  <label htmlFor="name" className="font-intel block mb-1 font-medium text-gray-700">
                    Name:
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label htmlFor="email" className="font-intel block mb-1 font-medium text-gray-700">
                    Email:
                  </label>
                  <input
                    type="email"
                ...
                <div>
                  <label htmlFor="message" className="font-intel block mb-1 font-medium text-gray-700">
                    Enter your message:
                  </label>
                  <textarea
                    name="message"
                ...
                <button
                  type="submit"
                  className="font-intel bg-pink-500 text-white py-3 px-6 rounded-full font-semibold hover:bg-black transition-all w-fit self-end"
                >
                  Send Message
                </button>
              </form>
